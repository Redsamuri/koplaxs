...
class LINE:
  ...
  def __init__(self):
    ...
    self._headers = {'X-Line-Application': 'IOSIPAD\t7.18.0\tiPhone OS\t10.12.1', 'X-Line-Access': 'self.authToken', 'User-Agent': 'Line/7.18.0'}
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {
              'X-Line-Application': 'IOSIPAD\t7.18.0\tiPhone OS\t10.12.1', 
